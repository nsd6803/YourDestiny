...
public class WeaponLFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_weapon_l, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageView square = getView().findViewById(R.id.imageView33);
        ImageView background = getView().findViewById(R.id.imageView51);
        ImageView back = getView().findViewById(R.id.imageView49);
        TextView title = getView().findViewById(R.id.item_name);
        TextView energy = getView().findViewById(R.id.item_predicat);
        TextView predicat = getView().findViewById(R.id.item_type);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (came_from == "yes"){
                    Navigation.findNavController(view).navigate(R.id.action_navigation_legendary_to_navigation_new);
                }
                    ...
                    Navigation.findNavController(view).navigate(R.id.action_navigation_legendary_to_navigation_result, bundle);
                }
                else{
                    Navigation.findNavController(view).navigate(R.id.action_navigation_legendary_to_navigation_weapon);
                }
            }
        });
